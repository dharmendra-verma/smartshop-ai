...
- [ ] `LOG_FILE` setting integrated into the `Settings` class (currently uses raw `os.getenv`)
- [ ] Comprehensive tests for file logging functionality
- [ ] Documentation updated (env vars reference)
